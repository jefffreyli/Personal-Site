...
export default function Example() {
  ...
  return (
   <>
   <div className="border border-gray-300 rounded-md px-3 py-2 shadow-sm focus-within:ring-1 focus-within:ring-dark-blue-3 focus-within:border-dark-blue-3">
    ...
    <div className="flex items-start space-x-4">
      <div className="min-w-0 flex-1">
        <form action="#" className="relative">
          <div className="border border-gray-300 rounded-lg shadow-sm overflow-hidden focus-within:border-dark-blue-3 focus-within:ring-1 focus-within:ring-dark-blue-3">
          ...
          <div className="absolute bottom-0 inset-x-0 pl-3 pr-2 py-2 flex justify-between">
            ...
            <div className="flex-shrink-0">
              <button
                type="submit"
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-dark-blue-2 hover:bg-dark-blue-3"
              >
                Post
              </button>
            </div>
